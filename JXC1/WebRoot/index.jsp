			...
			<div class="sidebar-wrapper">
				...
				<div class="mini-profile group">
					<div class="mini-user-avatar">
						<a href="#" title="欢迎您，${user.userName}!">
					...
					<div class="mini-user-info">
						${loggedUser.userName} <i class="icon icon-caret-down"></i>
					</div>
					<div class="mini-profile-options">
						<div class="user-info-cnt">
							欢迎您，${loggedUser.userName}! 
						</div>
				...
				<div id="mainnav">
					<div id="navlist-wraper">
						...
						<s:iterator value="#session.loggedUser.resourceMap" id="root">
