...
<head>
  ...
  <script type="text/javascript">	
			function test1(){
				...
				window.location="${pageContext.request.contextPath}/admin/sellbill/billsearch_findDisposeBysellbillId.html?sellbill.sellBillId="+newtemp;
...
<body>
    <div id="container" class="container">
      ...
      <div class="hr10"></div>
          ...
          <div class="hr10"></div>
          <h2>销售单查询</h2>
		<form id="form1" action="${pageContext.request.contextPath}/admin/sellbill/billsearch_dispose.html" method="post">
          <table class="m-table-form">
             <tbody>
                <tr>
                  ...
                  <th class="tr">终止日期：</th>
                  <td><input type="text" class="u-ipt" class="Wdate" name="sellDate2" value="${sellDate2}"
                  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"></td> 
             ...
             <tfoot>
               <tr>
                 <td colspan="7" class="tc">
                   ...
                   <button type="button" disabled="disabled" class="u-btn" id="update1" onclick="test1()">处理</button>              
                 </td>
               </tr>
             </tfoot>
          </table>
          ...
          <div align="center">
		   <ec:table items="sellbillList" var="SELLBILL"
				...
				action="${pageContext.request.contextPath}/admin/sellbill/billsearch_dispose.html"
